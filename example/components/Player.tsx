...
export default () => {
  ...
  const [playerStatus, setPlayerStatus] = useReducer<
    Reducer<PlayerStatus, Partial<PlayerStatus>>
  >((prevState, action) => ({ ...prevState, ...action }), initPlayerStatus);
    ...
    <View style={styles.container}>
      ...
      <View style={styles.controls}>
        <TouchableHighlight
          ...
          onPress={() =>
            setPlayerStatus({ isPlaying: !playerStatus.isPlaying })
          }
        >
        ...
        <TouchableHighlight
          onPress={() => {
            ExpoAndroidPip.hello();
            setPlayerStatus({ isPiPMode: !playerStatus.isPiPMode });
          }}
        >
